...
>2. $y = 2e+1$
>
>as this will not produce the desired graphs. Instead, switch to another independent variable, such as $x$, as shown below.
>1. $y = x^2$
>2. $y = 2x+1$
...
**Note:** The version of Desmos used on CollegeBoard exams, such as the #SAT and #AP exams, as well as the mobile app versions of the Desmos graphing calculator does *not* support copying and pasting of text. In these situations, it can be particularly useful to duplicate an entire line from the input panel, as described below.
