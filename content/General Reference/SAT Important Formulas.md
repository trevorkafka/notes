...
The SAT includes a reference sheet of useful formulas to help you answer questions on the exam. However, there are additional formulas that should also be known by students seeking the highest possible scores. 
...
>
><span class="invert">![[sat-reference-sheet.png]]</span>
...
> You can also compute the midpoint of two points by using the `midpoint` function. For example, to find the midpoint of the points $(1,2)$ and $(3,4)$, type into Desmos `midpoint((1,2),(3,4))`.
...
The quantity $b^2 - 4ac$ found in the quadratic formula is called the **discriminant** of a quadratic equation. When $a$, $b$, and $c$ are real numbers, knowledge of this value being positive, negative, or zero can help inform us of the nature of the solutions to the corresponding quadratic equation $ax^2 + bx + c = 0$.
...
| Vertex Form   | $y = a(x-h)^2 + k$    | Always possible         |
...
This is explained in much further detail on my page  [[Percentage Increase & Decrease]]. These sorts of comparisons are **very common** on the SAT and also are unfortunately much trickier than they seem at first glance.
...
<span class="invert">![[right-triangle-soh-cah-toa.png]]</span>
