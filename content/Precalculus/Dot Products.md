...
> 
> <span class="invert">![[dot-product-angle-between-vectors.png]]</span>
> 
...
> &= \underbrace{a \cos \theta_a}_{a_x}\ \underbrace{b \cos \theta_b}_{b_x} + \underbrace{a \sin \theta_a}_{a_y}\ \underbrace{b \sin \theta_b}_{b_y} \\
...
> y = \pm \frac{6}{\sqrt{29}}
> $$
> The final result is thus as follows, where the two $\pm$ signs are taken together (both $+$ or both $-$), since $y = \frac{2}{5}x$ requires $x$ and $y$ to have the same sign.
> $$
...
>Let $\vec{\mathbf a}$ and $\vec{\mathbf b}$ be arbitrary vectors and $k$ be any constant. Then, the commutative, distributive, and associative properties of dot products hold as described in the table below.
> 
> | Property              | Details                                                                                                                                     |
> | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
...
> | Associative Property | $(k \vec{\mathbf a}) \cdot \vec{\mathbf b} = k (\vec{\mathbf a} \cdot \vec{\mathbf b})$                                                     |
> 
...
<span class="invert">![[vector-projection.png]]</span>
...
>[!question] Problem 2
>Show that if $\vec{\mathbf u} = \vec{\mathbf a} -  \text{proj}_{\vec{\mathbf b}} \vec{\mathbf a}$, and neither $\vec{\mathbf u}$ nor $\vec{\mathbf b}$ is the zero vector, then $\vec{\mathbf u}$ is perpendicular to $\vec{\mathbf b}$.
...
> 
> <span class="invert">![[vector-projection-perpendicular-component.png]]</span>
> 
