...
| Formula         | Figure                                                                       |
| --------------- | ---------------------------------------------------------------------------- |
| $V = s^2 h$     | Volume of a prism with square base of side length $s$ and height $h$.        |
| $V = s^3$       | Volume of cube with side length $s$.                                         |
| $V = lwh$       | Volume of a prism with rectangular base of length $l$ and width $w$.         |
| $V = \pi r^2 h$ | Volume of a cylinder of radius $r$ (prism with circular base of radius $r$). |
...
| Formula                    | Figure                                                                     |
| -------------------------- | -------------------------------------------------------------------------- |
| $V = \frac{1}{3} s^2 h$    | Volume of a pyramid with square base of side length $s$ and height $h$.    |
| $V = \frac{1}{3}lwh$       | Volume of a pyramid with rectangular base of length $l$ and width $w$.     |
| $V = \frac{1}{3}\pi r^2 h$ | Volume of a cone of radius $r$ (pyramid with circular base of radius $r$). |
