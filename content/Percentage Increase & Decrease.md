...
tags:
  ...
  - "#ACT"
---
[Permalink](https://trevorkafka.github.io/notes/356443)
...
>[!question] Problem 3 (Challenging)
...
> $$
> \begin{gather*}
> s - \frac{9}{19} (s + z) = \frac{7}{10} \frac{9}{19} (s + z) + \frac{7}{10} z \\
> \frac{10}{19} s - \frac{9}{19} z = \frac{63}{190} s + \frac{98}{95} z \\
> z = \frac{37}{286} s
> \end{gather*}
> $$
> When we say that $z$ is $p\%$ smaller than the sum of $x$ and $y$, we mean
> $$z = \left( 1 - \frac{p}{100} \right) s.$$
> Comparing this with the result $z = \frac{37}{286} s,$ we can see that
> $$
> \begin{gather*}
> 	 1 - \frac{p}{100} = \frac{37}{286} \\
> 	 p = \frac{12450}{143} \approx 87.06
> \end{gather*}
> $$
