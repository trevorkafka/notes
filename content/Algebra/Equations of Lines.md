...
| Point-Slope Form $y - y_0 = m(x-x_0)$ | Easiest to write down when the line's slope and the coordinates of any single point on the line are known. (This is a *very* common situation, particularly in Calculus.) |
...
>$$
# Point-Slope Form
Point-slope form is an extremely useful and versatile version of an equation of a line. It allows us to immediately write down the equation of a line based on its slope and the coordinates of any single point on the line.
...
>[!question] Problem 1
>Write down the *Version 1* standard form equation of the line that passes through the points $(2,3)$ and $(5,1)$.
