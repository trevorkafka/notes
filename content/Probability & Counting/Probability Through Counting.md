...
>[!question] Problem 1
> If a number is chosen at random from 0–999, what is the probability that the number chosen contains an **odd number of odd digits**?
...
> 	- exactly one of the three digits is odd or
...
> 
> *Case 1: only one of the three digits is odd*
...
>In this situation, each digit has five possibilities. So, the number of three-digit numbers wherein all the digits are odd is also $5^3 = 125$. This covers case 2.
>
...
>[!question] Problem 2
>If a number is chosen at random from 0–999, what is the probability that the number chosen contains **three distinct digits**?
...
> 
> Using similar reasoning, one can determine that the number of strings in Cases 2–5 are each also $718200$. Hence, the number of strings with exactly one vowel is $5\cdot 718200 = 3591000$.
> 
...
>$$
>P = \boxed{\frac{55}{84} \approx 65.48\%}
>$$
