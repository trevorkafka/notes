...
>
><span class="invert">![[giancoli-fig-3-35-three-vectors.png]]</span>
...
>
><span class="invert">![[giancoli-fig-3-45-river-boat.png]]</span>
...
> 
> <span class="invert">![[river-boat-velocity-labels.png]]</span>
> 
...
> 
> <span class="invert">![[river-boat-velocities-shared-origin.png]]</span>
> 
...
> 
> <span class="invert">![[river-boat-velocities-tip-to-tail.png]]</span>
> 
...
> 
> <span class="invert">![[river-boat-velocity-components.png]]</span>
> 
...
>             &= 1.035849408 \approx \boxed{1.04\ \frac{\text{m}}{\text{s}}}
> \end{align*}
> $$
> 
...
> 
> <span class="invert">![[vector-sum-same-direction.png]]</span>
> 
>>[!note] Note
>>
>>This is the most extreme case of the *triangle inequality*. The triangle inequality in general guarantees that $V_R \leq V_1 + V_2$ regardless of the details of $\vec V_1$ and $\vec V_2$. The inequality sign turns into an equality when the two vectors $\vec V_1$ and $\vec V_2$ point in the same direction.
> 
...
> 
> <span class="invert">![[vector-sum-perpendicular.png]]</span>
> 
...
> 
> <span class="invert">![[plane-wind-tip-to-tail.png]]</span>
> 
