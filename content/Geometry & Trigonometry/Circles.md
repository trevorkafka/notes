...
<span class="invert">![[attachments/circle-equation-graph.png]]</span>
...
> [!check]- Solution 2
> Adding $\color{red} 5$ to both sides allows us to factor into standard circle equation form.
> $$
> \begin{gather*}
...
> $$
> <span class="invert">![[circle-tangent-to-both-axes.png]]</span>